        ...
        >
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-4">
            ...
            <p className="text-blue-100 text-sm">
              Fill in the information below to add a new art
            </p>
          </div>
          ...
          >
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Paintings" className="py-2">
                      Paintings
                    </option>
                    <option value="Sculptures" className="py-2">
                      Sculptures
                    </option>
                    <option value="Drawings" className="py-2">
                      Drawings
                    </option>
                    <option value="Digital Art" className="py-2">
                      Digital Art
                    </option>
                    <option value="Photography" className="py-2">
                      Photography
                    </option>
                    <option value="Calligraphy" className="py-2">
                      Calligraphy
                    </option>
                    <option value="Handicrafts" className="py-2">
                      Handicrafts
                    </option>
                    <option value="Textile & Fabric Art" className="py-2">
                      Textile & Fabric Art
                    </option>
                    <option value="Ceramics & Pottery" className="py-2">
                      Ceramics & Pottery
                    </option>
                    <option value="Mixed Media" className="py-2">
                      Mixed Media
                    </option>
            ...
            >
              <button
                className={`relative overflow-hidden px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-medium rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 ${
